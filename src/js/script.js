...
async function displayTrendingNews() {
  try {
    ...
    global.maxfetch = "6";
    fetchAPIData("world").then(function (data) {
      trendarticles = data.articles;
      // console.log(trendarticles);
...
async function displayMovie(url) {
  try {
    ...
    div1.innerHTML = `
    <img class="rounded-t-lg w-full h-full" src="https://image.tmdb.org/t/p/w300${data.results[0].poster_path}" alt="" />
        <div class="p-5">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">${data.results[0].original_title}</h5>
        </div>`;
    div2.innerHTML = `
    <img class="rounded-t-lg w-full h-full" src="https://image.tmdb.org/t/p/w300${data.results[1].poster_path}" alt="" />
        <div class="p-5">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">${data.results[1].original_title}</h5>
        </div>`;
    div3.innerHTML = `
    <img class="rounded-t-lg w-full h-full" src="https://image.tmdb.org/t/p/w300${data.results[2].poster_path}" alt="" />
        <div class="p-5">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">${data.results[2].original_title}</h5>
        </div>`;
    div4.innerHTML = `
    <img class="rounded-t-lg w-full h-full" src="https://image.tmdb.org/t/p/w300${data.results[7].poster_path}" alt="" />
        <div class="p-5">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">${data.results[7].original_title}</h5>
        </div>`;
    div5.innerHTML = `
    <img class="rounded-t-lg w-full h-full" src="https://image.tmdb.org/t/p/w300${data.results[8].poster_path}" alt="" />
        <div class="p-5">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">${data.results[8].original_title}</h5>
        </div>`;
    document.querySelector("#movie1").appendChild(div1);
    document.querySelector("#movie2").appendChild(div2);
    document.querySelector("#movie3").appendChild(div3);
    document.querySelector("#movie4").appendChild(div4);
    document.querySelector("#movie5").appendChild(div5);
  } catch (error) {
    console.error("An error occurred:", error.message);
  }
}
...
async function displayAdvice() {
  try {
    ...
    div.innerHTML = `
    <a href="#">
      <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Advise of the Day</h5>
    </a>
    <p class="mb-3 text-2xl font-normal text-gray-700 dark:text-gray-400">${result.slip.advice}</p>
...
async function displayJokes() {
  try {
    ...
    div.innerHTML = `
    <a href="#">
                      <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">It's joke time.</h5>
                      </a>
                      <p class="mb-3 text-2xl font-normal text-gray-700 dark:text-gray-400">${result[0].joke}</p>
...
async function displayFacts() {
  try {
    ...
    <a href="#">
                      ...
                      <p class="mb-3 text-2xl font-normal text-gray-700 dark:text-gray-400">${result[0].fact}</p>
...
function weather() {
  ...
  async function getWeatherData() {
    ...
    try {
      fetchAPIData("weather").then((data) => {
